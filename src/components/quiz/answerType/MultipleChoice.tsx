...
const MultipleChoice = ({ index }: { index: number }) => {
    ...
    updateQuizData.contentSetting = updateQuizData.contentSetting.map(
      (content, index2) => {
        if (index === index2) {
          ...
          // Check if multipleChoice is an array before mapping
          content = {
            ...content,
            questionSetting: {
              ...questionSetting,
              multipleChoice: questionSetting.multipleChoice.map(
                (item, multiindex) => {
                  if (multiChoiceIndex === multiindex) {
                    return {
                      ...item,
            ...
            if (index === index2) {
              ...
              content = {
                ...
                questionSetting: {
                  ...questionSetting,
                  multipleChoice: [
                    ...questionSetting.multipleChoice,
    ...
    <div>
      <div>
        ...
        <div className="flex flex-col gap-3 place-items-start">
          {quizData.contentSetting[index].questionSetting.multipleChoice.map(
